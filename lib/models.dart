...
// --- 채팅 스레드(단체/DM/그룹) ---
class ChatThread {
  final String id;        // threadId (예: teamId, dm_<teamId>_<a>_<b>, grp_<teamId>_<uuid>)
  final String teamId;    // 소속 팀
  final String type;      // 'team' | 'dm' | 'group'
  final String title;     // 표시 이름
  final List<String> memberIds; // 참여자(그룹/DM), team 채널은 비워도 됨
