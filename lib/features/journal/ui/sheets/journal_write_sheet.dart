          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(hintText: '제목', hintStyle: const TextStyle(color: AppColors.text2), filled: true, fillColor: AppColors.bg, border: OutlineInputBorder(borderRadius: BorderRadius.circular(16), borderSide: BorderSide.none)),
              ),
              ...
              DropdownButtonFormField<String?>(
                ...
                decoration: InputDecoration(hintText: '관련 업무(선택)', hintStyle: const TextStyle(color: AppColors.text2), filled: true, fillColor: AppColors.bg, border: OutlineInputBorder(borderRadius: BorderRadius.circular(16), borderSide: BorderSide.none)),
              ...
              DropdownButtonFormField<String?>(
                ...
                dropdownColor: AppColors.surface,
                style: const TextStyle(color: AppColors.text, fontWeight: FontWeight.bold),
                decoration: InputDecoration(hintText: '프로젝트(선택)', hintStyle: const TextStyle(color: AppColors.text2), filled: true, fillColor: AppColors.bg, border: OutlineInputBorder(borderRadius: BorderRadius.circular(16), borderSide: BorderSide.none)),
