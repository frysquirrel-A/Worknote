...
class _ScheduleTabState extends State<ScheduleTab> {
                  ...
                  Row(
                    children: [
                      ...
                      IconButton(
                        ...
                        onPressed: () =>
                            setState(() => _isCardMode = !_isCardMode),
                      ),
                    ],
                  ),
              ...
              (d) => Container(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    ...
                    color: d == '일'
                        ? AppColors.danger
                        : (d == '토' ? Colors.blue : AppColors.muted),
                  ),
                ),
              ),
            )
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: events.take(4).map((e) {
                        final isSingleDay =
                            e.range == null ||
                            isSameDay(e.range!.start, e.range!.end);
                        final color = e.type == _EventType.task
                        ...
                        if (!_isCardMode) {
                          ...
                          final isStart =
                              e.range != null && isSameDay(e.range!.start, day);
                          final isEnd =
                              e.range != null && isSameDay(e.range!.end, day);
                          ...
                          return Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.horizontal(
                                left: (isSingleDay || isStart)
                                    ? const Radius.circular(4)
                                    : Radius.zero,
                                right: (isSingleDay || isEnd)
                                    ? const Radius.circular(4)
                                    : Radius.zero,
                              ),
                            ),
                            child:
                                (isSingleDay ||
                                    isStart ||
                                    day.weekday ==
                                        7) // 시작일이거나 한 주의 시작(일요일)이면 텍스트 표시
                                ? Text(
                                    e.title,
                                    style: const TextStyle(
                                      fontSize: 9,
  ...
  Widget _eventTile({
    ...
    final icon = e.type == _EventType.task
              ...
              child: Column(
                ...
                children: [
                  Text(
                    e.title,
                    style: TextStyle(
                      color: e.type == _EventType.task && e.isDone
                          ? AppColors.muted
                          : AppColors.text,
                      fontWeight: FontWeight.w900,
                      fontSize: 15,
                      decoration: e.type == _EventType.task && e.isDone
  ...
  Future<void> _showPersonalScheduleSheet({
    ...
    await showModalBottomSheet(
      ...
      builder: (ctx) => _PersonalScheduleSheetContent(
        teamId: teamId,
        myId: myId,
        myName: myName,
        initial: initial,
...
class _PersonalScheduleSheetContent extends StatefulWidget {
  ...
  @override
  State<_PersonalScheduleSheetContent> createState() =>
      _PersonalScheduleSheetContentState();
}

class _PersonalScheduleSheetContentState
    extends State<_PersonalScheduleSheetContent> {
  ...
  void initState() {
    ...
    _range =
        widget.initial != null && scheduleProv.getRange(widget.initial!) != null
