    ...
    return Row(
      children: [
        ...
        ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(
            backgroundColor: _priorityColor(widget.task.priority).withOpacity(0.08),
      ...
      child: Column(
        children: [
          SwitchListTile(
            ...
            subtitle: const Text('일정 탭에 기간 일정으로 표시', style: TextStyle(fontSize: 12)),
          ),
          if (_includeInSchedule)
            Padding(
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      const Text('일정 기간', style: TextStyle(fontWeight: FontWeight.w900, color: AppColors.text)),
                      const Spacer(),
                      Text(
